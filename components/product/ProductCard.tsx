...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  return (
    <Link href={`/products/${product.id}`} className="block">
      <div className="w-full max-w-70 mx-auto border border-gray-200 p-5 bg-white font-sans hover:shadow-lg transition-shadow duration-300 cursor-pointer h-full flex flex-col">
        {/* Category */}
        ...
        {/* Add to Cart Button */}
        <button
          className="w-full cursor-pointer bg-[#17a2b8] hover:bg-[#138496] text-white py-3 px-4 transition-colors text-xl font-light mt-auto"
          onClick={(e) => {
            e.preventDefault();
